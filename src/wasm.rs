...
#[wasm_bindgen(js_name = QubicClientConfig)]
pub struct QubicClientConfigHandle {
    inner: crate::QubicClientConfig,
}

#[wasm_bindgen(js_class = QubicClientConfig)]
impl QubicClientConfigHandle {
    ...
    pub fn new(
        ...
        let mut inner = crate::QubicClientConfig::default();
        ...
        if let Some(url) = archive_url {
            inner.archive_url = url;
        }
        if let Some(url) = stats_url {
            inner.stats_url = url;
        }
        Self { inner }
    }
...
#[wasm_bindgen(js_name = QubicClient)]
pub struct QubicClientHandle {
    inner: crate::QubicClient,
}

#[wasm_bindgen(js_class = QubicClient)]
impl QubicClientHandle {
    #[wasm_bindgen(constructor)]
    pub fn new(config: QubicClientConfigHandle) -> Self {
        Self {
            inner: crate::QubicClient::with_config(config.inner),
        }
    }

    #[wasm_bindgen(getter)]
    pub fn live(&self) -> wasm_openapi::LiveApiHandle {
        wasm_openapi::LiveApiHandle::new(self.inner.clone())
    }

    #[wasm_bindgen(getter)]
    pub fn query(&self) -> wasm_openapi::QueryApiHandle {
        wasm_openapi::QueryApiHandle::new(self.inner.clone())
    }

    #[wasm_bindgen(getter)]
    pub fn archive(&self) -> wasm_openapi::ArchiveApiHandle {
        wasm_openapi::ArchiveApiHandle::new(self.inner.clone())
    }

    #[wasm_bindgen(getter)]
    pub fn stats(&self) -> wasm_openapi::StatsApiHandle {
        wasm_openapi::StatsApiHandle::new(self.inner.clone())
    }
}

#[path = "wasm_openapi.rs"]
mod wasm_openapi;
